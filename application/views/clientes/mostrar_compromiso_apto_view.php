...
//                            alert(msg2[0][2]);
                                                        ...
                                                        var localizacion = "<?php echo base_url() ?>" + "compromisos/" + msg2[0][0] + "/compraventa_de_" + nombre + "_" + $("#filtrar").val() + extension;
                                                        var localizaciondoc = "<?php echo base_url() ?>" + "compromisos/" + msg2[0][0] + "/compraventa_de_" + nombre + "_" + $("#filtrar").val() + extensiondoc;
//                            alert(localizacion);
