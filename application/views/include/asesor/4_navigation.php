            ...
            <ul>
                <li>
                    <a href="<?php echo base_url() ?>asesor/">
                        <i class="fa fa-tachometer fa-fw"></i> <span class="menu-text">Home</span>
                        <span class="selected"></span>
                    </a>					
                </li>
                <li class="has-sub">
                    <a href="javascript:;" class="">
                        <i class="fa fa-user fa-fw"></i> <span class="menu-text">Gestión de cuenta</span>
...
<!--                        <li><a class="" href="<php echo base_url() ?>admin/nuevo_asesor/"><span class="sub-menu-text">Agregar Un Nuevo Asesor</span></a></li>
                        ...
                        <li><a class="" href="<?php echo base_url() ?>asesor/actualizar_informacion/"><span class="sub-menu-text">Actualizar Información De Cuenta</span></a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub">
                        <li><a class="" href="<?php echo base_url()?>asesor/"><span class="sub-menu-text">Clientes Constructora JYP</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/clientes_proyecto/"><span class="sub-menu-text">Clientes Constructora JYP Proyecto</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/clientes_separacion/"><span class="sub-menu-text">Clientes Que han Separado</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/clientes_compra_venta/"><span class="sub-menu-text">Clientes Compromiso Compra-Venta</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/clientes_escritura_vivienda/"><span class="sub-menu-text">Clientes Escritura Vivienda</span></a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub">
                        <li><a class="" href="<?php echo base_url()?>asesor/ficha_tecnica/"><span class="sub-menu-text">Ficha Técnica</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/separacion_inmueble/"><span class="sub-menu-text">Separacion Inmueble</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/compromiso_compraventa/"><span class="sub-menu-text">Compromiso de CompraVenta</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/buscar_ficha_tecnica/"><span class="sub-menu-text">Buscar Ficha Técnica</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/mostrar_separacion_apto/"><span class="sub-menu-text">Buscar Separación</span></a></li>
                        <li><a class="" href="<?php echo base_url()?>asesor/mostrar_compromiso_apto/"><span class="sub-menu-text">Buscar Compromiso Compra-Venta</span></a></li>
                    </ul>
                </li>
