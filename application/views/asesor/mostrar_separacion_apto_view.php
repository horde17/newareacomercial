...
//                            alert(msg2[0][2]);
                                                        var nombre = msg2[0][1] + " " + msg2[0][2];
                                                        var extension = ".pdf";
                                                        var extensiondoc = ".doc";
                                                        var localizacion = "<?php echo base_url() ?>" + "separaciones/" + msg2[0][0] + "/separacion_de_" + nombre + "_identificacion_" + $("#filtrar").val() + extension;
                                                        var localizaciondoc = "<?php echo base_url() ?>" + "separaciones/" + msg2[0][0] + "/separacion_de_" + nombre + "_identificacion_" + $("#filtrar").val() + extensiondoc;
//                            alert(localizacion);
                                                        $("#link").attr('href', localizaciondoc);
                                            ...
                                            <div class="row">
                                                <div id="googledrive" class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <a id="link"><button class="btn btn-primary">Descargue el Word del Pdf </button></a>
                                                        </div>
                                                        <div class="col-lg-4"></div>
                                                    </div>
                                                </div>
